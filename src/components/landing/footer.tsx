        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              />
              <span className="text-xl font-semibold text-white">HairWise+</span>
            </Link>
            <p className="text-sm text-ash max-w-xs">
              AI-powered hair health analysis for men who want results, not guesswork.
            </p>
            <div className="flex gap-4 mt-6">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-slate-blue/50 hover:bg-slate-blue flex items-center justify-center transition-colors"
                aria-label="Twitter"
              >
        ...
        <div className="mt-12 pt-8 border-t border-slate-blue/30">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
            <p className="text-sm text-ash">
              &copy; {new Date().getFullYear()} HairWise+. All rights reserved.
            </p>
